  ...
  <div class="container">
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
      <a href="../index.php" class="d-flex align-items-center mb-2 mb-lg-0 link-body-emphasis text-decoration-none">
        <img src="./../../imagem/site/logoBranco.png" width="30" height="30" class="d-inline-block align-top" alt="">
      </a>
      ...
      <div class="dropdown text-end">
        <a href="#" class="text-white d-block link-body-emphasis text-decoration-none dropdown-toggle"
          ...
          <img src="./../../imagem/site/mina.jpg" alt="error img" width="32" height="32" class="rounded-circle">
        </a>
