        ...
        <div class="card">
          <form method="post" action="controller.php" enctype="multipart/form-data" class="needs-validation" novalidate>
            <div class="card-header">
              <strong>INFORMAÇÕES DO USUÁRIO (ADMIN)</strong>
            </div>
              ...
              <div class=" col-md-10">
                <div class="row">
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <input type="text" class="form-control" name="cpf" maxlength="50" id="cpf"  data-mask="000.000.000-00" data-mask-selectonfocus="true">
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-3">
